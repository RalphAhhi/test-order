...
public class OrderService {
    ...
    public List<PlaceOrderResponse> findOrder(OrderListRequest orderListRequest) {
        ...
        return convertToDto(orderRepository.findAll(pageable));
    }

    private List<PlaceOrderResponse> convertToDto(Page<Order> orders) {
    ...
    private Sort.Direction getDirection(OrderListRequest orderListRequest) {
